...
exports.CommandCooldownPlugin = exports.MessageBufferPlugin = exports.WaRateLimiterPlugin = exports.AntiSpamPlugin = void 0;
const KvStore_js_1 = require("../stores/KvStore.cjs");
/**
...
class AntiSpamPlugin {
    ...
    constructor(options = {}) {
        this.opts = {
            ...
            kv: options.kv ?? new KvStore_js_1.KvStore(),
...
exports.AntiSpamPlugin = AntiSpamPlugin;
/**
...
exports.WaRateLimiterPlugin = WaRateLimiterPlugin;
/**
...
exports.MessageBufferPlugin = MessageBufferPlugin;
/**
...
exports.CommandCooldownPlugin = CommandCooldownPlugin;
