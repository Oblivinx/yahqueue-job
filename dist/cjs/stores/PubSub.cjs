...
exports.IpcPubSubBridge = exports.TypedPubSub = exports.PubSub = void 0;
 ...
 * ```
 */
class PubSub extends node_events_1.EventEmitter {
...
exports.IpcPubSubBridge = IpcPubSubBridge;
